...
<main class="c-app flex-row align-items-center" style="min-height:100vh;">
  ...
  <div class="mb-3">
    ...
    <input type="text" id="full_name" name="full_name" value="<?= old('full_name') ?>"
      class="form-control <?= $validation && $validation->hasError('full_name') ? 'is-invalid' : '' ?>" required>
  ...
  <div class="col-12 col-lg-6">
    ...
    <input type="text" id="username" name="username" value="<?= old('username') ?>"
      class="form-control <?= $validation && $validation->hasError('username') ? 'is-invalid' : '' ?>" required>
  ...
  <div class="col-12 col-lg-6">
    ...
    <input type="tel" id="phone" name="phone" value="<?= old('phone') ?>"
      class="form-control <?= $validation && $validation->hasError('phone') ? 'is-invalid' : '' ?>" required>
...
<div class="row gx-2 gy-3 mt-3">
  <div class="col-12 col-lg-6">
    ...
    <input type="password" id="password" name="password"
      class="form-control <?= $validation && $validation->hasError('password') ? 'is-invalid' : '' ?>" required>
  ...
  <div class="col-12 col-lg-6">
    ...
    <input type="password" id="password_confirm" name="password_confirm"
      class="form-control <?= $validation && $validation->hasError('password_confirm') ? 'is-invalid' : '' ?>" required>
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="email" id="email" name="email" value="<?= old('email') ?>"
      class="form-control <?= $validation && $validation->hasError('email') ? 'is-invalid' : '' ?>" required>
