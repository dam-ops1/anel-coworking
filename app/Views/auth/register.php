...
<main class="c-app d-flex align-items-center" style="min-height:100vh;">
    <div class="container">
        <div class="d-flex bg-white mx-auto" style="
      ...
      ">
            ...
            <div class="d-none d-md-flex align-items-center" style="padding:0 1rem;">
                <div class="vr" style="height:500px; border-color:#dee2e6;"></div>
            </div>

            <!--  Formulario -->
            <div class="p-5 d-flex flex-column justify-content-center" style="flex:0 0 60%;">
